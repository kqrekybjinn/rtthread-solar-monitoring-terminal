...
#define INA226_CONFIG_AVG1_BUS1100US_SHUNT1100US_CONT  0x4127
                           ...
                           float max_current_a)
{
    ...
    if (ina226_write_u16(dev, INA226_REG_CONFIG, INA226_CONFIG_AVG1_BUS1100US_SHUNT1100US_CONT) != RT_EOK)
    {
        return -RT_ERROR;
    }
