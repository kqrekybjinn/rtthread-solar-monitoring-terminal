...
#define PCB02_PIN_PWM_BUCK         GET_PIN(A, 5)   /* Temporary flywire buck_IN, TIM2_CH1 */
...
#define PCB02_PIN_FAULT_N          GET_PIN(B, 4)   /* PCB-02 -> PCB-03 low-active fault, open-drain */
#define PCB02_PIN_CAN_STB          GET_PIN(A, 10)  /* TCAN3413 STB, low = normal mode */
#define PCB02_PIN_LED_FAULT        GET_PIN(B, 2)   /* Local fault LED */
#define PCB02_PIN_GPIO17_DISABLE   GET_PIN(B, 15)  /* CN2 signal pin, abandoned as high-Z input */
