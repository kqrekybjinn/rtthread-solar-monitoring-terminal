...
#define INA226_CONFIG_AVG128_BUS1100US_SHUNT1100US_CONT 0x4927

static rt_err_t ina226_write_u16(ups_ina226_t *dev, rt_uint8_t reg, rt_uint16_t value)
{
    rt_uint8_t buf[3];
...
static rt_err_t ina226_read_u16(ups_ina226_t *dev, rt_uint8_t reg, rt_uint16_t *value)
{
    rt_uint8_t data[2];
                         ...
                         float max_current_a)
{
    ...
    if (ina226_write_u16(dev, INA226_REG_CONFIG, INA226_CONFIG_AVG128_BUS1100US_SHUNT1100US_CONT) != RT_EOK)
    {
        return -RT_ERROR;
    }
